...
const addTestMedicalRecords = async () => {
    try {
        ...
        if (!patient) {
            console.log('❌ No patient found. Please create a patient account first.');
            process.exit(1);
        }
        ...
        const sampleRecords = [
            ...
            },
            {
                ...
                labTests: ['Blood Pressure Monitoring', 'Lipid Profile', 'Kidney Function Test'],
                vitalSigns: {
                ...
                notes: 'Patient advised to reduce salt intake, exercise regularly (30 min daily), and monitor BP at home. Lifestyle modifications are crucial.',
                ...
                prescription: [
                    {
                        ...
                        duration: '8 weeks',
                        instructions: 'Take with milk or after a fatty meal for better absorption'
                    },
                    {
