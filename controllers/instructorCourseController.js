...
exports.listCourses = async (req, res) => {
  try {
    ...
    const courses = await InstructorCourse.find(filter).populate('instructor', 'user');
...
exports.updateCourse = async (req, res) => {
  try {
    ...
    const updated = await InstructorCourse.findByIdAndUpdate(id, { $set: req.body }, { new: true });
